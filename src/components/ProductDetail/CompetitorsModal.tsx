          ...
          {confirmedCompetitorDetails.length === 0 ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {[...confirmedCompetitorDetails]
                ...
                .map((comp) => {
                  const cheaper = typeof comp.price === 'number' && comp.price > 0 && comp.price < selectedProductPrice;
                  ...
                  return (
                    <div
                      ...
                      className={`relative bg-gray-50 rounded-lg border p-3 flex flex-col items-center text-center ${
                        cheaper ? 'border-green-300' : !equal && comp.price ? 'border-red-200' : ''
                      }`}
                    >
                      {/* Delete button */}
                      <button
                      ...
                      {comp.price && (
                        <p className={`font-bold mb-2 ${cheaper ? 'text-green-600' : equal ? 'text-blue-600' : 'text-red-600'}`}>
